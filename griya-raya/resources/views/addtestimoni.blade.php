...
<div class="container  testimoni-user">
    ...
    <div class="row align-items-start justify-content-center">
        <div class="col-6">
            ...
            <div class="pull-left">
                <p class="fs-1 top text-center">Testimony</p >
                    <p class="fs-6 text-center" style="font-weight: normal;">Give your experience using Griya Raya wedding organizer below!</p>
            </div>
            <div class="pull-right">
                <a class="backadmin" href="/testimoni"><button class="btn">Back</button></a>
            </div>
            <form action="/add-testimoni" method="POST" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="name" value=" {{ auth()->user()->name }}">
                <p class="fs-3">Name: {{ auth()->user()->name }}</p>
                <p class="fs-3">Photo:</p>
                <input type="file" name="foto" class="form-control" placeholder="foto">
                <p class="fs-3">Testimony:</p>
                    <input type="text" name="isi_testimoni" class="form-control" placeholder="Description">
