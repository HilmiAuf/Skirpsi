    ...
    <div class="container " style="width: 100%; height: 100%;">
        <div class="row admin">
            <div class="col-sm-12 col-md-6 col-lg-4 mb-2 justify-content-start ">
                <div class="card text-center pt-2" style="background-color: #00897A;">
            ...
            <div class=" col-sm-12 col-md-6 col-lg-4 mb-2 justify-content-start">
                <div class="card text-center pt-2 justify-content-center" style="background-color: #3949AB;" href="/">
                    <img src="/source/img/testimoni.png" class="card-img-top" alt="...">
                    <h5 class="card-title text-white">Testimoni</h5>
            ...
            <div class=" col-sm-12 col-md-6 col-lg-4 mb-2 justify-content-start">
                <div class="card text-center pt-2" style="background-color: #d81a60;">
            ...
            <div class=" col-sm-12 col-md-6 col-lg-4 mb-2 justify-content-start">
                <div class="card text-center pt-2" style="background-color: #757575;">
                    <img src="/source/img/Profile.png" class="card-img-top" alt="...">
                    <h5 class="card-title text-white">Pengguna</h5>
