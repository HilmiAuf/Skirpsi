    ...
    <div class="container pt-5 ">
        <div class="row ">
            ...
            <div class="col-sm-12 col-md-6 col-lg-4">
                <p class="fs-4">Menu </p>
                <div class="row justify-content-start list-unstyled list-inline ">
                    <div class="col-4">
                        ...
                        <li><a class="nav-link fs-6 me-4 dropdown-toggle" href="#" role="button"
            ...
            <div class="col-sm-12 col-md-6 col-lg-4">
                <ul class="list-unstyled list-inline ">
                    ...
                    <li><i class="text-white fas fa-phone me-1"></i> Nomor Telepon : 085222160047 </li>
            ...
            <div class="col-4">
                <ul class="list-unstyled list-inline ">
                    <li class="list-inline-item"><a href="https://www.facebook.com/raya.sln"
                            class="btn-floating btn-sm text-white"><i class="fab fa-facebook"></i></a></li>
                    <li class="list-inline-item"><a href="https://www.instagram.com/raya_griyapengantin/"
                            class="btn-floating btn-sm text-white"><i class="fab fa-instagram"></i></a></li>
                    <li class="list-inline-item"><a href="https://goo.gl/maps/QxQCJGme8Zrptjzg9"
                            class="btn-floating btn-sm text-white"><i class="fab fa-google"></i></a></li>
                    <li class="list-inline-item"><a href="wa.me/6289664970144" class="btn-floating btn-sm text-white"><i
